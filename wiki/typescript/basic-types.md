...
toc: true
group: nest
permalink: /wiki/typescript/basic-types
---
...
和JavaScript一样，TypeScript里的所有数字都是浮点数。 这些浮点数的类型是 `number`。 除了支持十进制和十六进制字面量，TypeScript还支持`ECMAScript 2015`中引入的二进制和八进制字面量。
